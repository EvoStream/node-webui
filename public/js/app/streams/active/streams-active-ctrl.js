            ...
            resolve: {
                ...
                deleteMessage: function () {
                    ...
                    if (streamRowTemp.hasOwnProperty('pullSettings')) {
                        ...
                        deleteMessage = 'stream '+streamRowTemp.hlsSettings.groupName;
                    } else if (streamRowTemp.hasOwnProperty('hdsSettings')) {
                        deleteMessage = 'stream '+streamRowTemp.hdsSettings.groupName;
                    } else if (streamRowTemp.hasOwnProperty('dashSettings')) {
                        deleteMessage = 'stream '+streamRowTemp.dashSettings.groupName;
                    } else if (streamRowTemp.hasOwnProperty('mssSettings')) {
                        deleteMessage = 'stream '+streamRowTemp.mssSettings.groupName;
                    }
